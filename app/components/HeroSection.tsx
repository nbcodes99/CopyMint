  ...
  return (
    <section className="flex flex-col items-center px-6 md:px-24 py-24 overflow-hidden">
      ...
      <div className="max-w-3xl flex flex-col items-center text-center px-3">
        <p className="mb-6 md:mb-4 px-4 py-1 text-sm bg-black/40 border border-orange-500 rounded-full text-orange-400">
          🔥 Solutions
        </p>

        <h1 className="text-5xl md:text-6xl font-bold mb-6 text-zinc-200 leading-tight">
